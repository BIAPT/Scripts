...
#n=np.where([(Y_ID_Base=='WSAS19')])
#ax.scatter(X3[n, 0], X3[n, 1],X3[n, 2], marker='o',color='green',label="Chronic_misclassified")
plt.title('Baseline')
plt.legend()
