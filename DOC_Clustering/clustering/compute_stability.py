...
data_acute=data[(Y_ID == '05') | (Y_ID == '10') | (Y_ID == '18') | (Y_ID == '12')]
...
[SI_M_reco ,SI_SD_reco] = clustering.stability_measure.compute_stability_index(X_reco,Y_ID_reco, P, K, Rep)
[SI_M_acute ,SI_SD_acute] = clustering.stability_measure.compute_stability_index(X_acute,Y_ID_acute, P, K, Rep)
